...
public class PetStoreService {
	...
	public PetStoreData = PetStoreData savePetStore(PetStoreData petStoreData){
	...
	private void copyEmployeeFields (Employee employee,
			pet.store.controller.model.PetStoreEmployee petStoreEmployee) {
	...
	public PetStoreEmployee saveEmployee(Long petStoreId,
		...
		CrudRepository<PetStore, Long> employeeDao;
	...
	public PetStoreCustomer saveCustomer(Long petStoreId,
		...
		CrudRepository<PetStore, Long> customerDao;
	...
	@Transactional(readOnly = true)
	public java.util.List<PetStoreData> retrieveAllPetStore() {
		List <PetStore> petStores = petStoreDao.findAll();
		
		java.util.List<PetStoreData> result = new LinkedList<>();
